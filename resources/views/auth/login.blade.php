                ...
                <div class="flex flex-col break-words bg-white border border-2 rounded shadow-md">
                    ...
                    <form class="w-full p-6" method="POST" action="{{ route('login') }}">
                        ...
                        <div class="flex flex-wrap items-center">
                            <button type="submit" class="bg-sky-600 hover:bg-sky-800 text-gray-100 font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">
                                {{ __('Login') }}
                            </button>

                            @if (Route::has('password.request'))
                                <a class="text-sm text-sky-500 hover:text-sky-700 whitespace-no-wrap no-underline ml-auto" href="{{ route('password.request') }}">
                            ...
                            @if (Route::has('register'))
                                <p class="w-full text-xs text-center text-gray-700 mt-8 -mb-4">
                                    ...
                                    <a class="text-sky-500 hover:text-sky-700 no-underline" href="{{ route('register') }}">
                                        Register
                                    </a>
                                </p>
                            @endif
